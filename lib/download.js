...
async function getAssetFromCDN(opts, assetName) {
  ...
  // https://gw.alipayobjects.com/os/lib/opensumi/ripgrep-prebuilt/1.4.0/build/ripgrep-v13.0.0-4-aarch64-apple-darwin/rg.r3bin
  const asset = {
    url: `https://gw.alipayobjects.com/os/lib/opensumi/ripgrep-prebuilt/${prebuiltVersion}/build/${assetName}`,
  };
...
module.exports = async (opts) => {
  ...
  // fake r3bin file, it's just a binary with a specific extension.
  const assetName =
